...
|3   |SolidState        |[SolidState](https://github.com/h4md153v63n/CTFs/blob/main/01_HTB/10_SolidState.md)|-|unix,authenticated rce,cron/scheduled tasks,rbash/restricted shell,smtp/pop/imap,ssh,stored creds,telnet|
